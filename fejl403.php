...
<html lang="da">
<head>
    <!-- typefacen på din hjemmeside -->
    <meta charset="utf-8">
    <!-- Responsiv design -->
    <meta name="viewport" content="width=device-width, initial-scales=1">
    <!-- Max ca 160 karakterer -->
    ...
    <!-- OpenGraph bruges når din hjemmeside bliver delt på sociale medier -->
    ...
    <!-- link til css fil -->
    <link href="Css/fejl403.css" rel="stylesheet" type="text/css">
</head>
...
<main>
    <h1>UPS!</h1>
    <p>
        Denne side har du ikke adgang til vælg venligst en anden i hovede menuen
    </p>
</main>
